...
export default function Toast() {
  ...
  return (
    <div
      className={`toast fixed bottom-5 left-4 z-50 flex max-w-sm items-center gap-3 rounded-lg border border-white/10 bg-ink-950 px-4 py-3 text-white shadow-lift sm:left-5 ${
        visible ? 'show' : ''
      }`}
      role="status"
      aria-live="polite"
